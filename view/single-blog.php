    ...
    <!--================Blog Area =================-->
     ...
     <?php 
                            ...
                            @$atk_id=$_GET['atk_id'];
                            $qr=mysql_query("SELECT * FROM tbl_artikel INNER JOIN tbl_pengelola ON tbl_artikel.png_id=tbl_pengelola.png_id  WHERE tbl_artikel.atk_id='$atk_id'")or die (mysql_error());
                    ...
                    <div class="single-post row">
                        <div class="col-lg-12">
                            <div class="feature-img">
                                <img class="img-fluid" src="admin/images/upload/<?php echo $atk_gambar; ?>" alt="">
                            </div>
                        </div>
