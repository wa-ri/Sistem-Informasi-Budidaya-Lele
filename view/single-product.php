	...
	@$pdk_id=$_GET['pdk_id'];
		$qw3=mysql_query("SELECT * FROM tbl_produk
		INNER JOIN tbl_kategori ON tbl_produk.pdk_ktg=tbl_kategori.ktg_id
		 WHERE tbl_produk.pdk_id='$pdk_id'")or die (mysql_error());
		$arr=mysql_fetch_array($qw3) or die(mysql_error());
		extract($arr);
			...
			<div class="row s_product_inner">
						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							<ol class="carousel-indicators">
								<li data-target="#carouselExampleIndicators" data-slide-to="0">
									<img src="admin/images/product/<?php echo $pdk_img ?>" alt="" style="width: 70px">
								</li>
								
							</ol>
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100" src="admin/images/product/<?php echo $pdk_img ?>" alt="First slide">
								</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3><?php echo $pdk_nama; ?></h3>
						<h2 ><?php echo "Rp.".number_format($pdk_harga,0,',','.'); ?></h2>
						<input type="text" id="harga" value="<?php echo $pdk_harga; ?>" hidden="true">
						<ul class="list">
							<li>
								<a class="active" href="#">
									<span>Category</span> : <?php echo $ktg_nama; ?></a>
							</li>
							<!-- <li>
								<a href="#">
						...
						<div class="card_area">
							<a class="main_btn valid add_cart" href="" id="<?php echo $pdk_id; ?>">Add to Cart</a>
